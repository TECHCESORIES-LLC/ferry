(function () {
  ...
  function initClouds() { clouds.length = 0; var n = reduce ? 4 : 12; for (var i = 0; i < n; i++) clouds.push({ x: rand(0, W), y: rand(10, surfaceY * 0.5), s: rand(1.2, 2.6), sp: rand(5, 14) }); }
  ...
  function drawClouds(off) {
    for (var i = 0; i < clouds.length; i++) {
      ...
      for (var b = 0; b < 5; b++) {
        ...
        var top = flash > 0.3 ? '#6b7e86' : '#4c5f67', bot = flash > 0.3 ? '#48595f' : '#36484f';
